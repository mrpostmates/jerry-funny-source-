	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'jerry':
				...
				frames = Paths.getSparrowAtlas('jerry/FUCKING_JERRY!!!');
				
				animation.addByPrefix('idle', "jerry_idle", 24, false);
				animation.addByPrefix('singUP', "up_animmm", 24, false);
				animation.addByPrefix('singDOWN', "get realistic", 24, false);
				animation.addByPrefix('singLEFT', "jerry left", 24, false);
				animation.addByPrefix('singRIGHT', "he go right", 24, false);
				...
				frames = Paths.getSparrowAtlas('jerry/Mysterious_Alcoholic_Beverage');
				
				animation.addByPrefix('idle', "drunk idle", 24, false);
				animation.addByPrefix('singUP', "drunk up", 24, false);
				animation.addByPrefix('singDOWN', "drunk down", 24, false);
				animation.addByPrefix('singLEFT', "drunk left", 24, false);
				animation.addByPrefix('singRIGHT', "drunk right", 24, false);
